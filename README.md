...
Deze mode is ideaal voor A2–B1‑leerlingen die hun grammaticale reflexen willen aanscherpen. HARDSPAANS dwingt je om sneller te herkennen welke werkwoorden uitzonderingen hebben en hoe je die correct toepast in verschillende tijden. Door ook een voorbeeldzin te maken, train je niet alleen de vorm, maar ook het gebruik in context.
...
Installeer Streamlit:
pip install streamlit

Start de trainer:
streamlit run hardspaans_app.py

HARDSPAANS is ontworpen om uitdagend, leerzaam en motiverend te zijn, zodat je soepel kunt doorgroeien naar het hoogste niveau: HARDCORE.
